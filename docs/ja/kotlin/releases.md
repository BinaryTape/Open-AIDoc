...
各言語リリースおよびツールリリースについては、新機能が正式にリリースされる前に試用できるよう、いくつかのプレビュー（_EAP_）バージョンも提供しています。詳細は [Kotlin Early Access Previewへの参加](eap.md) を参照してください。
...
Kotlinは、[IntelliJ IDEA](https://www.jetbrains.com/idea/download/) および [Android Studio](https://developer.android.com/kotlin/get-started) で標準（out-of-the-box）で完全にサポートされています。
...
<table>
    ...
    <tr>
        <td><strong>2.4.20</strong>
            <p>リリース日: <strong>2026年9月7日</strong></p>
            <p><a href="https://github.com/JetBrains/kotlin/releases/tag/v2.4.20" target="_blank">GitHubでのリリース</a></p>
        </td>
        <td>
            <p>新しい実験的および安定した機能、パフォーマンスの向上、バグ修正、およびツールのアップデートを含むツールリリースです。</p>
            <p>詳細は<a href="https://github.com/JetBrains/kotlin/releases/tag/v2.4.20">変更履歴</a>を参照してください。</p>
        </td>
    </tr>
    <tr>
